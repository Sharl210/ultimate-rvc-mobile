...
### ‼️注意 
**本项目非Ultimate RVC的手机版，是基于原版RVC的，且仅适配了V2版模型，至于为啥是这个取名，源于项目初期，由于一些原因误打误撞用的ultimate-rvc-mobile作为最开始的基底壳子（当时不知道没细查以为就是rvc🤣，然后这边当时还是个空壳，就直接在这边开发了，/AI搜的别问我。。。然后因为这个底座的源项目已经删库了，我clone的也是另一个别人clone的仓库，所以后来这边补好实际功能后就做成独立仓库了，为了致意原仓库，软件和仓库名称也就没改了）**
